...
The testing environment has been a cPouta VM in CSC and a VM in DataCrunch. Both VMs have Kubernetes cluster which are sert up with k3s and orchestrated by Liqo.
